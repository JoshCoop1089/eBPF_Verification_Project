...
# create_program(program_list, 10, 64)
...
num_regs = 10
reg_size = 64
program_list = ['movI8 114 0', 'jmpI4 19 0 4', 'jmpR 0 0 5', 'addR 0 0', 'movI8 -70 1', 'jmpI8 54 0 3', 'movI4 76 7', 'addR 1 0', 'addI4 -98 7', 'exit 0 0']

# random_program_creator(num_ins, num_regs, reg_size)
